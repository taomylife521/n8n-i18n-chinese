import { d as defineComponent, a6 as useRoute, b as useRouter, ah as useFoldersStore, r as ref, x as computed, c as useI18n, ar as ProjectTypes, V as VIEWS, O as resolveComponent, h as createElementBlock, g as openBlock, i as createVNode, w as withCtx, s as N8nCard, n as normalizeClass, j as createBaseVNode, f as createCommentVNode, e as createBlock, hC as ProjectCardBadge, l as unref, aH as ResourceType, g2 as N8nActionToggle, bP as withModifiers, p as N8nText, k as createTextVNode, t as toDisplayString, gr as _sfc_main$3, m as N8nHeading, aw as N8nBadge, N as N8nIcon, _ as _export_sfc, a as useToast, v as useSettingsStore, T as useUIStore, u as useUsersStore, a5 as useWorkflowsStore, ag as useProjectsStore, an as getResourcePermissions, hv as dateFormat, aT as withDirectives, aU as vShow, ay as WORKFLOW_SHARE_MODAL_KEY, az as useTelemetry, aG as DUPLICATE_MODAL_KEY, aB as useMessage, aC as MODAL_CONFIRM, aI as PROJECT_MOVE_RESOURCE_MODAL, hD as FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX, hE as ILLEGAL_FOLDER_CHARACTERS, hF as FOLDER_NAME_ONLY_DOTS_REGEX, hG as FOLDER_NAME_MAX_LENGTH, af as useSourceControlStore, R as useTagsStore, gH as useUsageStore, hH as useInsightsStore, bc as useTemplatesStore, aj as useDocumentTitle, S as useDebounce, aq as EnterpriseEditionFeature, dS as isExtraTemplateLinksExperimentEnabled, ab as watch, o as onMounted, Q as createEventBus, I as onBeforeUnmount, L as debounce, hI as PROJECT_ROOT, as as useTemplateRef, bg as createSlots, $ as N8nTooltip, q as N8nButton, fQ as N8nActionBox, fZ as N8nInputLabel, av as _sfc_main$5, cW as N8nSelect, F as Fragment, y as renderList, cX as _sfc_main$6, gF as N8nCheckbox, hJ as Draggable, fE as N8nLoading, at as InlineRename, dw as N8nCallout, hK as DEFAULT_WORKFLOW_PAGE_SIZE, bk as trackTemplatesClick, bl as TemplateClickSource, eY as getEasyAiWorkflowJson, gI as COMMUNITY_PLUS_ENROLLMENT_MODAL } from "./index-DS4Zr0kd.js";
import { _ as _sfc_main$4 } from "./EmptySharedSectionActionBox.vue_vue_type_script_setup_true_lang-CudxBVAp.js";
import { B as Breadcrumbs, W as WorkflowActivator, _ as __unplugin_components_0 } from "./WorkflowActivator-C0VuqB2V.js";
import { R as ResourcesListLayout } from "./ResourcesListLayout-BRRsDbFJ.js";
import { P as ProjectHeader } from "./ProjectHeader-Co5czbON.js";
import { T as Tags } from "./Tags-xZXwPqSD.js";
import { u as useProjectPages } from "./useProjectPages-BT9GTOpf.js";
import { I as InsightsSummary } from "./InsightsSummary-TqVutHv4.js";
import { u as useAITemplatesStarterCollectionStore } from "./aiTemplatesStarterCollection.store-DwI93AVv.js";
import "./useWorkflowActivate-CzPopU9S.js";
import "./TableBase-B07QrYce.js";
...
const _hoisted_1$1 = { "data-test-id": "folder-card" };
...
const __unplugin_components_4 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__cssModules", cssModules$2]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(ResourcesListLayout, {
        ...
        "onUpdate:filters": [
          _cache[5] || (_cache[5] = ($event) => filters.value = $event),
          onFiltersUpdated
        ],
        ...
        callout: withCtx(() => [
          showAIStarterCollectionCallout.value ? (openBlock(), createBlock(_component_N8nCallout, {
            ...
            _: 1
          }, 8, ["class"])) : !loading.value && showEasyAIWorkflowCallout.value && easyAICalloutVisible.value ? (openBlock(), createBlock(_component_N8nCallout, {
            key: 1,
            theme: "secondary",
            icon: "bot",
            class: normalizeClass(_ctx.$style["easy-ai-workflow-callout"])
