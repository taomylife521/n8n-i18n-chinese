const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-1BbYqBs7.js","assets/index-lYG7K1rT.js","assets/index-COleXxZf.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-DpIVgjjA.js","assets/chartjs.utils-lxCOo72X.js","assets/InsightsSummary-FyKC55Tq.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-BXqZMRYi.js","assets/InsightsChartFailed-Dluj_SH9.js","assets/InsightsChartFailureRate-BVrb0tuH.js","assets/InsightsChartTimeSaved-r7SJ0D1B.js","assets/InsightsChartAverageRuntime-BmbySADf.js","assets/InsightsTableWorkflows-DBVsIypk.js","assets/N8nDataTableServer-DsO6G_e9.js","assets/InsightsTableWorkflows-DJhX6bQW.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, cU as useModel, hj as useInsightsStore, r as ref, hz as UNLICENSED_TIME_RANGE, hn as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, y as renderList, l as unref, f2 as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, f1 as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, hA as ElDialog, al as usePageRedirectionHelper, _ as _export_sfc, et as defineAsyncComponent, aa as watch, o as onMounted, ai as useDocumentTitle, m as N8nHeading, n as normalizeClass, eE as _sfc_main$4, b_ as resolveDynamicComponent, ay as useTelemetry, hB as TELEMETRY_TIME_RANGE, aI as __vitePreload } from "./index-lYG7K1rT.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-1BbYqBs7.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-DpIVgjjA.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-Dluj_SH9.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-BVrb0tuH.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-r7SJ0D1B.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-BmbySADf.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-DBVsIypk.js"), true ? __vite__mapDeps([13,1,2,14,6,7,15]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
