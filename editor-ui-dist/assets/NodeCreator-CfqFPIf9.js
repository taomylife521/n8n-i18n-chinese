import { d as defineComponent, h as createElementBlock, g as openBlock, D as mergeProps, j as createBaseVNode, J as renderSlot, f as createCommentVNode, n as normalizeClass, e as createBlock, t as toDisplayString, l as unref, iX as ElTag, w as withCtx, k as createTextVNode, N as N8nIcon, h4 as useI18n, i as createVNode, _ as _export_sfc, eI as reactive, o as onMounted, be as useExternalHooks, I as onBeforeUnmount, bV as toRefs, dR as useNodeCreatorStore, iY as useViewStacks, ff as useNodeType, bH as useNodeTypesStore, r as ref, x as computed, iZ as DEFAULT_SUBCATEGORY, i_ as CREDENTIAL_ONLY_NODE_PREFIX, c as useI18n$1, i$ as shouldShowCommunityNodeDetails, j0 as HITL_SUBCATEGORY, dd as isCommunityPackageName, j1 as isNodePreviewKey, j2 as removePreviewToken, c4 as resolveDirective, bg as createSlots, $ as N8nTooltip, aT as withDirectives, dg as COMMUNITY_NODES_INSTALLATION_DOCS_URL, aU as vShow, P as normalizeStyle, bQ as _sfc_main$o, bP as withModifiers, f3 as DRAG_EVENT_DATA_KEY, az as useTelemetry, j3 as camelCase, j4 as N8nNodeIcon, ip as WEBHOOK_NODE_TYPE, j5 as getNewNodePosition, cD as DEFAULT_NODE_SIZE, u as useUsersStore, p as N8nText, q as N8nButton, j6 as useKeyboardNavigation, a5 as useWorkflowsStore, ab as watch, bW as normalizeProps, bX as guardReactiveProps, b$ as onUnmounted, F as Fragment, y as renderList, fE as N8nLoading, j7 as REGULAR_NODE_CREATOR_VIEW, d8 as useCommunityNodesStore, db as i18n, d9 as captureException, e7 as CUSTOM_API_CALL_KEY, iy as TRIGGER_NODE_CREATOR_VIEW, il as OPEN_AI_NODE_TYPE, ik as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, j8 as withMemo, j9 as HTTP_REQUEST_NODE_TYPE, dw as N8nCallout, er as InfoTip, cZ as createStaticVNode, a2 as N8nLink, ja as REQUEST_NODE_FORM_URL, jb as useCalloutHelpers, jc as filterAndSearchNodes, jd as getRootSearchCallouts, je as prepareCommunityNodeDetailsViewStack, ej as getNodeIconSource, ir as transformNodeType, jf as AINodesView, jg as AIView, jh as RegularView, ji as TriggerView, jj as flattenCreateElements, jk as getHumanInTheLoopActions, jl as AI_OTHERS_NODE_CREATOR_VIEW, jm as AI_NODE_CREATOR_VIEW, a as useToast, du as useCredentialsStore, S as useDebounce, da as N8nNotice, dK as Transition, jn as AI_EVALUATION, jo as AI_UNCATEGORIZED_CATEGORY, T as useUIStore, fa as useAssistantStore, dU as useBuilderStore, a0 as _sfc_main$q, jp as SlideTransition, jq as useActionsGenerator } from "./index-DS4Zr0kd.js";
import { u as useActions } from "./NodeCreation-DBWTdkNN.js";
import { b as _sfc_main$p, C as CommunityNodeFooter } from "./NodeView-nJIgPUbP.js";
...
import "./import-curl-CpKPeEv5.js";
import "./global-link-actions-DsrycW5M.js";
import "./useExecutionDebugging-cGfwkiNc.js";
import "./useBeforeUnload-Bc4Lv6x7.js";
import "./aiTemplatesStarterCollection.store-DwI93AVv.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_n8n_node_creator_node, {
        ...
        icon: withCtx(() => [
          createVNode(_sfc_main$o, { "node-type": _ctx.action }, null, 8, ["node-type"])
        ]),
        _: 1
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      const _component_CommunityNodeUpdateInfo = _sfc_main$p;
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(_ctx.$style.container)
      }, [
        createVNode(unref(N8nText), {
          ...
          (openBlock(), createElementBlock("aside", {
            ...
            createBaseVNode("header", {
              ...
              createBaseVNode("div", {
                ...
                activeViewStack.value.nodeIcon ? (openBlock(), createBlock(_sfc_main$o, {
                  key: 1,
                  class: normalizeClass(_ctx.$style.nodeIcon),
