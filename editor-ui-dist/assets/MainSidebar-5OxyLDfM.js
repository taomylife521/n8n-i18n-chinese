import { d as defineComponent, r as ref, e as createBlock, g as openBlock, w as withCtx, i as createVNode, l as unref, aV as ElSubMenu, n as normalizeClass, h as createElementBlock, F as Fragment, y as renderList, aW as _sfc_main$6, aX as ElMenuItem, f as createCommentVNode, k as createTextVNode, J as renderSlot, N as N8nIcon, t as toDisplayString, D as mergeProps, aY as withKeys, aZ as ElMenu, _ as _export_sfc, a_ as get, a$ as useLoadingService, T as useUIStore, ae as useSourceControlStore, af as useProjectsStore, a as useToast, x as computed, ao as hasPermission, am as getResourcePermissions, P as normalizeStyle, j as createBaseVNode, $ as N8nTooltip, q as N8nButton, c as useI18n, Q as createEventBus, aD as SOURCE_CONTROL_PUSH_MODAL_KEY, b0 as notifyUserAboutPullWorkFolderOutcome, b1 as sourceControlEventBus, b2 as SOURCE_CONTROL_PULL_MODAL_KEY, a2 as defineStore, b3 as useCloudPlanStore, ac as useRootStore, b4 as useStorage, b5 as DateTime, a7 as STORES, ay as useTelemetry, v as useSettingsStore, b as useRouter, b6 as sortByProperty, V as VIEWS, al as usePageRedirectionHelper, u as useUsersStore, aR as onBeforeMount, O as resolveComponent, b7 as N8nMenuItem, p as N8nText, b8 as useDebugInfo, b9 as useVersionsStore, a1 as N8nLink, ba as VERSIONS_MODAL_KEY, bb as useTemplatesStore, a4 as useWorkflowsStore, S as useDebounce, a5 as useRoute, bc as RELEASE_NOTES_URL, o as onMounted, bd as useExternalHooks, K as nextTick, I as onBeforeUnmount, be as onClickOutside, a0 as _sfc_main$7, bf as createSlots, z as N8nAvatar, bg as N8nMenu, bh as WHATS_NEW_MODAL_KEY, bi as ABOUT_MODAL_KEY, bj as trackTemplatesClick, bk as TemplateClickSource } from "./index-BSyItHSy.js";
import { N as N8nActionDropdown } from "./ActionDropdown-CrODAGHq.js";
import { L as Logo } from "./Logo-CmlmuWXq.js";
...
const __unplugin_components_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__cssModules", cssModules$2], ["__scopeId", "data-v-dca93fa7"]]);
  ...
  setup(__props) {
    ...
    const mainMenuItems = computed(() => [
      ...
      },
      {
        ...
        available: settingsStore.settings.activeModules.includes("insights") && hasPermission(["rbac"], { rbac: { scope: "insights:list" } })
      },
      {
        id: "help",
        icon: "circle-help",
