              ...
              return openBlock(), createElementBlock("tr", {
                ...
                tableData.value.metadata.hasExecutionIds ? (openBlock(), createElementBlock("td", {
                  ...
                  createVNode(unref(N8nTooltip), {
                    ...
                    default: withCtx(() => [
                      tableData.value.metadata.data[index1] ? withDirectives((openBlock(), createBlock(unref(_sfc_main$2), {
                        key: 0,
                        element: "a",
                        type: "secondary",
                        icon: "external-link",
