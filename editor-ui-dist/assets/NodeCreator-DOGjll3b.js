import { d as defineComponent, h as createElementBlock, g as openBlock, D as mergeProps, j as createBaseVNode, J as renderSlot, f as createCommentVNode, n as normalizeClass, e as createBlock, t as toDisplayString, l as unref, iw as ElTag, w as withCtx, k as createTextVNode, N as N8nIcon, gI as useI18n, i as createVNode, _ as _export_sfc, ee as reactive, o as onMounted, bf as useExternalHooks, I as onBeforeUnmount, bX as toRefs, dD as useNodeCreatorStore, ix as useViewStacks, gi as useNodeType, bI as useNodeTypesStore, r as ref, x as computed, iy as DEFAULT_SUBCATEGORY, iz as CREDENTIAL_ONLY_NODE_PREFIX, c as useI18n$1, iA as shouldShowCommunityNodeDetails, iB as HITL_SUBCATEGORY, c_ as isCommunityPackageName, iC as isNodePreviewKey, iD as removePreviewToken, c6 as resolveDirective, bh as createSlots, $ as N8nTooltip, aU as withDirectives, d1 as COMMUNITY_NODES_INSTALLATION_DOCS_URL, aV as vShow, P as normalizeStyle, bR as _sfc_main$p, bQ as withModifiers, eC as DRAG_EVENT_DATA_KEY, ay as useTelemetry, iE as camelCase, iF as N8nNodeIcon, hV as WEBHOOK_NODE_TYPE, iG as getNewNodePosition, cF as DEFAULT_NODE_SIZE, u as useUsersStore, p as N8nText, q as N8nButton, iH as useKeyboardNavigation, a4 as useWorkflowsStore, aa as watch, bY as normalizeProps, bZ as guardReactiveProps, c1 as onUnmounted, F as Fragment, y as renderList, eF as N8nLoading, iI as REGULAR_NODE_CREATOR_VIEW, fe as useCommunityNodesStore, fN as i18n, iJ as captureException, b as useRouter, a1 as N8nLink, V as VIEWS, dW as CUSTOM_API_CALL_KEY, i2 as TRIGGER_NODE_CREATOR_VIEW, hS as OPEN_AI_NODE_TYPE, hR as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, iK as withMemo, iL as HTTP_REQUEST_NODE_TYPE, di as N8nCallout, eR as InfoTip, gF as createStaticVNode, iM as REQUEST_NODE_FORM_URL, iN as useCalloutHelpers, iO as filterAndSearchNodes, iP as getRootSearchCallouts, iQ as prepareCommunityNodeDetailsViewStack, e7 as getNodeIconSource, hX as transformNodeType, iR as AINodesView, iS as AIView, iT as RegularView, iU as TriggerView, iV as flattenCreateElements, iW as getHumanInTheLoopActions, iX as AI_OTHERS_NODE_CREATOR_VIEW, iY as AI_NODE_CREATOR_VIEW, a as useToast, dg as useCredentialsStore, S as useDebounce, dq as N8nNotice, dJ as Transition, iZ as AI_EVALUATION, i_ as AI_UNCATEGORIZED_CATEGORY, T as useUIStore, f_ as useAssistantStore, dG as useBuilderStore, a0 as _sfc_main$q, i$ as SlideTransition, j0 as useActionsGenerator } from "./index-lYG7K1rT.js";
import { u as useActions } from "./NodeCreation-DHWzjNiq.js";
import "./NodeView-BdOF7UA1.js";
import "./ActionDropdown-Bp9eVY3g.js";
import "./useKeybindings-BGqybTI7.js";
import "./import-curl-C_MaFFFd.js";
import "./global-link-actions-iPJEIwpo.js";
import "./useExecutionDebugging-D4kWxVdU.js";
import "./useBeforeUnload-Dr55cKoH.js";
...
const NodeCreatorNode = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__cssModules", cssModules$m], ["__scopeId", "data-v-878aee66"]]);
...
const SearchBar = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["__cssModules", cssModules$l]]);
const _hoisted_1$9 = {
  viewBox: "0 0 24 24",
  width: "1.2em",
  height: "1.2em"
...
const NodeItem = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__cssModules", cssModules$k]]);
...
const SubcategoryItem = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__cssModules", cssModules$j]]);
...
const LabelItem = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__cssModules", cssModules$i]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_n8n_node_creator_node, {
        ...
        icon: withCtx(() => [
          createVNode(_sfc_main$p, { "node-type": _ctx.action }, null, 8, ["node-type"])
        ]),
        _: 1
...
const ActionItem = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["__cssModules", cssModules$h]]);
...
const ViewItem = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__cssModules", cssModules$g]]);
...
const LinkItem = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__cssModules", cssModules$f]]);
...
const CommunityNodeInstallHint = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__cssModules", cssModules$e]]);
...
const CommunityNodeItem = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__cssModules", cssModules$d]]);
...
const CategoryItem = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__cssModules", cssModules$c]]);
...
const CategorizedItemsRenderer = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__cssModules", cssModules$b]]);
...
const OpenTemplateItem = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__cssModules", cssModules$a]]);
          ...
          (openBlock(), createElementBlock("aside", {
            ...
            createBaseVNode("header", {
              ...
              createBaseVNode("div", {
                ...
                activeViewStack.value.nodeIcon ? (openBlock(), createBlock(_sfc_main$p, {
                  key: 1,
                  class: normalizeClass(_ctx.$style.nodeIcon),
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        ...
        _ctx.active ? (openBlock(), createBlock(_sfc_main$q, {
          key: 0,
