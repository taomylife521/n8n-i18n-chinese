const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-ZU8oSNL1.js","assets/index-CfkULtaE.js","assets/index-BFyMw9-0.css","assets/NodeCreator-COgNP4W1.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, Z as useUIStore, cG as useFocusPanelStore, fe as useAssistantStore, h0 as useActions, h as createElementBlock, g as openBlock, f as createCommentVNode, e as createBlock, n as normalizeClass, i as createVNode, w as withCtx, a5 as _sfc_main$1, l as unref, c as useI18n, ck as KeyboardShortcutTooltip, q as N8nButton, j as createBaseVNode, d7 as _sfc_main$2, k as createTextVNode, t as toDisplayString, a4 as N8nTooltip, ds as defineAsyncComponent, dr as Suspense, F as Fragment, aW as __vitePreload, dt as NODE_CREATOR_OPEN_SOURCES, h1 as getMidCanvasPosition, b2 as STICKY_NODE_TYPE, ap as useTelemetry, h2 as DEFAULT_STICKY_WIDTH, h3 as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-CfkULtaE.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-ZU8oSNL1.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const props = __props;
    const emit = __emit;
