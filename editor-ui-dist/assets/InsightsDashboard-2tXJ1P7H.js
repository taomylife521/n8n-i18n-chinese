const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-C7h-DM_o.js","assets/index-CfkULtaE.js","assets/index-BFyMw9-0.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-Duc1d0SC.js","assets/chartjs.utils-k5ogn_Uc.js","assets/InsightsSummary-D9sGV3Ln.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-C75N3SnX.js","assets/InsightsChartFailed-Bq5ENojm.js","assets/InsightsChartFailureRate-CzuL4QO6.js","assets/InsightsChartTimeSaved-BOPTqLT7.js","assets/InsightsChartAverageRuntime-UxZj6brx.js","assets/InsightsTableWorkflows-D1kZ0Wgk.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, ee as useModel, g6 as useInsightsStore, r as ref, gD as UNLICENSED_TIME_RANGE, gf as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, l as unref, e7 as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, e6 as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, gE as ElDialog, aB as usePageRedirectionHelper, _ as _export_sfc, aa as useRoute, gF as INSIGHT_TYPES, ds as defineAsyncComponent, af as watch, o as onMounted, ay as useDocumentTitle, m as N8nHeading, n as normalizeClass, dH as _sfc_main$4, c8 as resolveDynamicComponent, aW as __vitePreload, ap as useTelemetry, gG as TELEMETRY_TIME_RANGE } from "./index-CfkULtaE.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-C7h-DM_o.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-Duc1d0SC.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-Bq5ENojm.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-CzuL4QO6.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-BOPTqLT7.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-UxZj6brx.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-D1kZ0Wgk.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
