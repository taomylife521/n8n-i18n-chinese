import { d as defineComponent, br as isRef, cd as shallowRef, aa as watch, r as ref, cL as watchEffect, aK as h, l as unref, cR as mergeModels, cJ as useSlots, x as computed, cS as useModel, h0 as ElCheckbox, cb as useThrottleFn, h as createElementBlock, g as openBlock, j as createBaseVNode, f as createCommentVNode, P as normalizeStyle, n as normalizeClass, F as Fragment, y as renderList, e as createBlock, k as createTextVNode, t as toDisplayString, bO as withModifiers, i as createVNode, h1 as ElSkeletonItem, J as renderSlot, D as mergeProps, h2 as _sfc_main$1, h3 as ElSelect, w as withCtx, h4 as ElOption, bq as get, _ as _export_sfc } from "./index-BSyItHSy.js";
/**
   * table-core
   *
...
const _hoisted_9 = { class: "table-pagination__sizes" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
          ...
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("table", {
              ...
              createBaseVNode("tbody", null, [
                _ctx.loading && !unref(table).getRowModel().rows.length ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(itemsPerPage.value, (item) => {
                ...
                }), 128)) : unref(table).getRowModel().rows.length ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(unref(table).getRowModel().rows, (row) => {
        ...
        showPagination.value ? (openBlock(), createElementBlock("div", _hoisted_8, [
...
const N8nDataTableServer = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-037c8d4b"]]);
export {
